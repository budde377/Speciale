...
\vspace{2ex}
\begin{flushright}
  \emph{Christian Budde Christensen \& Randi Katrine Hillerøe}\\
  \emph{Aarhus, \today.}
\end{flushright}

\tableofcontents
\todo{be consistent about title casing or not title casing for headings}
\clearpage
...
\label{ch:study}
\input{chapters/study/intro}
\input{chapters/study/hypothesis}
...
\input{chapters/staticAnalysis/intro}
...
\input{chapters/staticAnalysis/summary}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Case Study}
\label{ch:evaluation}
\input{chapters/caseStudy/intro}
\input{chapters/caseStudy/noErrors}
\input{chapters/caseStudy/joomlaArrayPivot}
\input{chapters/caseStudy/codeIgniterDirectoryHelper}
\input{chapters/caseStudy/magentoDateValidation}
\input{chapters/caseStudy/partTypeHandler}
\input{chapters/caseStudy/arrayPop}
\input{chapters/caseStudy/conclusion}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\chapter{Future Work}
\label{ch:futureWork}
\input{chapters/futureWork/intro}
\input{chapters/futureWork/fullLanguage}
\input{chapters/futureWork/precision}
\input{chapters/futureWork/performance}
\input{chapters/futureWork/summary}
