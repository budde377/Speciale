Evaluating the analysis presented in chapter \ref{ch:analysis} is performed by analysing six small P0 programs. These programs have been found by manually inspecting the corpus from chapter \ref{ch:study}. 
