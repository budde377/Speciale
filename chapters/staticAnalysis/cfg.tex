...
\begin{program}
\subcaptionbox{Example of normal return-statement}{
\begin{lstlisting}

\end{lstlisting}
}%
\subcaptionbox{Example of reference return-statement}{
\begin{lstlisting}
...
The remaining three graphs are the empty graph, the graph of the expression, and the graph of the block statement which are all straight-foward.
