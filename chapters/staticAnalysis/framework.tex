...
\ContinuedFloat
\hspace*{\fill}
\subcaptionbox{\label{fig:floweret}}{\begin{adjustbox}{max size={.25\textwidth}{.25\textheight}}\begin{tikzpicture}[node distance = 2cm, auto]
    % Place nodes
    \node [entry] (en) {};
    \node [node, below of=en] (rc) {}
    \node [node, right of=rc] (exit) {}
    \node [emptynode, below of=rc] (end) {}
    \node [exit, below of=end] (ex) {};

\end{tikzpicture}\end{adjustbox}}\hfill%
\subcaptionbox{\label{fig:flowrret}}{\begin{adjustbox}{max size={.25\textwidth}{.25\textheight}}\begin{tikzpicture}[node distance = 2cm, auto]
    % Place nodes
...
%    \path [line] (e3) -> (end);
    ...
    \path [line] (if) -- (-3, -6) |- (end);
\end{tikzpicture}\end{adjustbox}}\hfill%
\subcaptionbox{\label{fig:flowret}}{\begin{adjustbox}{max size={.25\textwidth}{.25\textheight}}\begin{tikzpicture}[node distance = 2cm, auto]
    % Place nodes
    \node [entry] (en) {};
    \node [subtree,below of=en] (e1) {$E(t)$};
    \node [node, below of=e1, label={35:$if(t)$}] (if) {};
